...
macro(find_component _component _pkgconfig _library _header)
  find_path(FFmpeg_${_component}_INCLUDE_DIRS ${_header} PATHS ${VCPKG_INSTALLED_LIB_DIR}/include)
  find_library(FFmpeg_${_component}_LIBRARIES NAMES ${_library} PATHS ${VCPKG_INSTALLED_LIB_DIR}/lib)
...
foreach(_component ${FFmpeg_FIND_COMPONENTS})
  ...
  if (FFmpeg_${_component}_FOUND)
    message(STATUS ${_component} "founded")
